...
def main():
    ...
    write_to_gdoc(kyivstarfmc_inst) if kyivstarfmc_inst else print(f'{kyivstarfmc.__name__} Error')
    ...
    prostor_inst = get_parser_instance(prostor, cnct_type='cabel', locality='Максимівка')
    write_to_gdoc(prostor_inst) if prostor_inst else print(f'{prostor.__name__} Error')

    # Prostor - Максимівка - wi-fi
    prostor_inst = get_parser_instance(prostor, cnct_type='wi-fi', locality='Максимівка')
    write_to_gdoc(prostor_inst) if prostor_inst else print(f'{prostor.__name__} Error')
    ...
    prostor_inst = get_parser_instance(prostor, cnct_type='cabel', locality='Новоселівка')
    write_to_gdoc(prostor_inst) if prostor_inst else print(f'{prostor.__name__} Error')
