...
class Intertelecom(DinamicParser):
    ...
    def parse(self):
        ...
        sleep(delay)
        button = browser.find_element_by_xpath('//button[@class="btn dropdown-toggle btn-default"]').click()
        sleep(delay)
...
def trf_parser(**params):
    ...
    parser = Intertelecom(
        name='intertelecom.ua',
        url='https://www.intertelecom.ua/home_internet_wifi',)
